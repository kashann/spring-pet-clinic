...
public class OwnerController {
    ...
    private static final String VIEWS_OWNER_OWNER_DETAILS = "owners/ownerDetails";
    ...
    public String processFindForm(Owner owner, BindingResult result, Model model) {
        ...
        if(owner.getLastName() == null) {
            owner.setLastName(""); // empty string means that it will be the broadest possible search
        }
